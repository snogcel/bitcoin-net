...
module.exports = function (_EventEmitter) {
  ...
  function Peer(params, opts) {
    ...
    _this.params = params;
    _this.protocolVersion = params.protocolVersion || 70103;
    _this.minimumVersion = params.minimumVersion || 70103;
  ...
  _createClass(Peer, [{
    ...
    value: function connect(socket) {
      ...
      socket.once('close', function () {
        return _this2.disconnect(new Error('Socket closed'));
      });
    ...
    value: function getBlocks(hashes, opts, cb) {
      ...
      hashes.forEach(function (hash, i) {
        ...
        _this5.once((opts.filtered ? 'merkle' : '') + 'block:' + hash.toString('base64'), onBlock);
      });
      ...
      timeout = setTimeout(function () {
        ...
        hashes.forEach(function (hash, i) {
          _this5.removeListener((opts.filtered ? 'merkle' : '') + 'block:' + hash.toString('base64'), listeners[i]);
        });
